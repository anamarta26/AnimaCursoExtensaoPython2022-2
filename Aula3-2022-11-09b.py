...
#Isso é uma declaração da função (Como ela funciona)
...
#Se eu quiser calcular o imposto destes quatro valores...e exibir na tela assim: "O imposto de ...é..."(1o. preco, 2o.imposto)
